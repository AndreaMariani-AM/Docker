...
docker build --progress=plain --no-cache -t andreamariani/rstudio_base:1106_noenv -t andreamariani/rstudio_base:latest . 2>&1 | tee stdout.log && \
docker push andreamariani/rstudio_base:1106_noenv
docker push andreamariani/rstudio_base:latest
