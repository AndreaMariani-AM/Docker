...
##===========================================##===========================================##
# docker build --progress=plain --no-cache -t andreamariani/wgbseq_snakemake:${IMAGE_VERSION} -t andreamariani/wgbseq_snakemake:latest . 2>&1 | tee stdout.log #&& \
# docker push andreamariani/wgbseq_snakemake:${IMAGE_VERSION}
# docker push andreamariani/wgbseq_snakemake:latest
...
##===========================================##===========================================##
docker build --progress=plain -t andreamariani/wgbseq_test:${IMAGE_VERSION} -t andreamariani/wgbseq_test:latest . 2>&1 | tee stdout.log
